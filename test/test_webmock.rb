...
class TestWebMockMini < MTest::Unit::TestCase
  ...
  def test_error_on_non_stubbed_request
    assert_raise_with_message(WebMockMini::NetConnectNotAllowedError, %r{Real HTTP connections are disabled. Unregistered request: GET http://www.example.net/ with headers}) do
